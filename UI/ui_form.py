...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.groupBox_2.setGeometry(QRect(860, 10, 411, 571))
        self.label = QLabel(self.groupBox_2)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(10, 10, 401, 61))
        self.label.setWordWrap(False)
        self.lineEditTimeForAnalysing = QLineEdit(self.groupBox_2)
        self.lineEditTimeForAnalysing.setObjectName(u"lineEditTimeForAnalysing")
        self.lineEditTimeForAnalysing.setGeometry(QRect(10, 60, 71, 20))
        self.label_2 = QLabel(self.groupBox_2)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(90, 40, 101, 61))
        self.label_2.setWordWrap(False)
        self.layoutWidget1 = QWidget(self.groupBox_2)
        self.layoutWidget1.setObjectName(u"layoutWidget1")
        self.layoutWidget1.setGeometry(QRect(20, 110, 361, 451))
        self.verticalLayout_2 = QVBoxLayout(self.layoutWidget1)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.textEditNormalX = QTextEdit(self.layoutWidget1)
        self.textEditNormalX.setObjectName(u"textEditNormalX")

        self.verticalLayout_2.addWidget(self.textEditNormalX)

        self.textEditNormalY = QTextEdit(self.layoutWidget1)
        self.textEditNormalY.setObjectName(u"textEditNormalY")

        self.verticalLayout_2.addWidget(self.textEditNormalY)

        self.pushButtonStartAnalysing = QPushButton(self.groupBox_2)
        self.pushButtonStartAnalysing.setObjectName(u"pushButtonStartAnalysing")
        self.pushButtonStartAnalysing.setGeometry(QRect(160, 60, 141, 31))
        self.layoutWidget2 = QWidget(self.tabNormal)
        self.layoutWidget2.setObjectName(u"layoutWidget2")
        self.layoutWidget2.setGeometry(QRect(16, 13, 811, 561))
